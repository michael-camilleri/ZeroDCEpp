...
#    srun --time=1-23:00:00 --gres=gpu:1 --nodelist=charles05 train_ZeroDCE.sh Frames_Raw_Ext 0.3 5 101 ZeroDCE++.pth 12 8 0.00001 20 &> logs/train_zdce_1e-5_20.log
...
python Zero-DCE++/lowlight_train.py \
  --images ${DATA_DIR} --validation_ratio ${VALID_RATE} --random_seed ${RAND_SEED} --downsample ${DOWNSAMPLE} \
